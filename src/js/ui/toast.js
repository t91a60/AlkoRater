...
const TOAST_ICONS = {
    ...
    update: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#d4a054" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="23 4 23 10 17 10"/><path d="M20.49 15a9 9 0 1 1-2.12-9.36"/></svg>',
